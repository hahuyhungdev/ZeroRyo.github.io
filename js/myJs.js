const textConfig = {
  ...
  text3: "em thích anh có phải không nào ._.",
  ...
  text11:
    "thôi khuya rồi sức khỏe k tốt ngủ đi nào. em ngủ ngonnnn",
  text12: "Okii lunn <3",
};
    ...
    Swal.fire({
      ...
      if (result.value) {
        Swal.fire({
          ...
          onClose: () => {
            window.location = "https://www.facebook.com/profile.php?id=100034932092514";
          },
        });
      }
    });
